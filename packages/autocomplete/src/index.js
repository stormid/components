...
//only way to produce something the renderer treats as markup rather than as text.
//`escapeHtml` is the underlying escaper, exported for escaping values by hand.
