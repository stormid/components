...
import factory, { Boilerplate } from './lib/factory';
 ...
 */
const init = (selector: string, options?: object ): Boilerplate[] => {
    ...
    return nodes.map((node: HTMLElement) => Object.create(factory({
