...
import { isValidDate, isFutureDate, isPastDate } from '../../../src/lib/plugins/methods/date.js';
...
describe('Validate > Integration > Plugins > Valid Date', () => {
    ...
    it('should return false for a missing day, month, or year', async () => {
        ...
        assert.deepStrictEqual(dateErrorNode.textContent, message);
    });
...
describe('Validate > Integration > Plugins > Date in future', () => {
    ...
    it('should add a validation method to a group', async () => {
        ...
        validator.addMethod('date', isFutureDate, message, dateFields);
        ...
        assert.deepStrictEqual(validator.getState().groups, {
            ...
            date: {
                serverErrorNode: dateErrorNode,
                validators: [{ type: 'custom', method: isFutureDate, message }],
                fields: dateFields,
                valid: false
            }
        });
...
describe('Validate > Integration > Plugins > Date in Past', () => {
    ...
    it('should add a validation method to a group', async () => {
        ...
        validator.addMethod('date', isPastDate, message, dateFields);
        ...
        assert.deepStrictEqual(validator.getState().groups, {
            ...
            date: {
                serverErrorNode: dateErrorNode,
                validators: [{ type: 'custom', method: isPastDate, message }],
                fields: dateFields,
                valid: false
            }
        });
