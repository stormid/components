...
describe('Validate > Integration > api > validate > minlength', () => {
    ...
    it('should validate a form based on the HTML5 minlength validator returning false, staring realTimeValidation, focusing on first invalid field, and rendering an error message if a field is invalid', async () => {
        expect.assertions(6);
    ...
    it('should validate a form based on the data-val minlength validator returning false, staring realTimeValidation, focusing on first invalid field, and rendering an error message if a field is invalid', async () => {
        expect.assertions(6);
        document.body.innerHTML = `<form class="form">
            <label id="group1-label" for="group1">group1</label>
            <input
