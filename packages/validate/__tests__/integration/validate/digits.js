...
describe('Validate > Integration > validate > digits', () => {
    ...
    it('should validate a form based on the data-val digits validator returning false, staring realTimeValidation, focusing on first invalid field, and rendering an error message if a field is invalid', async () => {
        expect.assertions(6);
