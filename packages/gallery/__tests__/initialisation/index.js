...
describe('Gallery > initialisation', () => {
    ...
    it('Should warn if no image container is found', () => {
        ...
        console.warn = jest.fn();
        gallery('.js-gallery');
        expect(console.warn).toHaveBeenCalledWith(`Gallery cannot find image container ${defaults.selector.imgContainer}`);
    ...
    it('Should warn if no img src, srcset, or loaded attributes are found', () => {
        ...
        console.warn = jest.fn();
        gallery('.js-gallery');
        expect(console.warn).toHaveBeenCalledWith('Gallery cannot be initialised, no image sources found');
    });
